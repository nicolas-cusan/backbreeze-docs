...
Backbreeze provides classes for a large number of CSS properties. This will allow for styling combining only classes without the need to write new CSS. Some benefits of this approach are:
