...
NOTE: for the above to work `$bb-colors` needs to be defined before its usage. This means that you need to include (and likely customize) it in your projects variables.
