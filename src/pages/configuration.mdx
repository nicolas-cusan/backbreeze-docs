...
## How to do configuration in Sass
...
Backbreeze provides `!default` configuration variables as its configuration API. Due to the way default variables work in Sass you need to overwrite any Backbreeze variables **before** including the Backbreeze `_config.scss` file (see [instalation](/installation#including-in-your-project)).

To actualy overwrite a default configuarion variable with your own values simply decalre it in your project variables:

```scss
// project config

// This declaration will overwritte each instance of the `!default` variable
$bb-colors: (
  'white': #fff,
  'black': #000,
  'primary': #006cd6,
...
Configuration variables are categorized the following way:
