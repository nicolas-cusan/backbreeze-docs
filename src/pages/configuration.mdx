...
Backbreeze exposes three kind of variables to customize: general, property-driven and internal.
...
Defines colors. Used in: `background-color`, `border-color`, `color`, `outline-color`
