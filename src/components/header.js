...
const Header = ({ siteTitle, version, github }) => (
  <header className="flx-none px-x.75 h-60 ai-center d-flx pos-fxd top-0 lft-0 rgt-0 bgc-txt c-white z-3">
    ...
    <a className="o-0.5:hover tsp-opacity tsd-200" href={github}>
